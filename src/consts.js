...
export const CommentTexts = [
  ...
  `Возникает вопрос: а на кого рассчитан этот тфильм? Его нельзя показывать из-за наличия жестокости. Откровенно глупо и безсмысленно: эротики нет, романтических нет, глубокий смысл, экшен и драматизм отсутствуют!`,
